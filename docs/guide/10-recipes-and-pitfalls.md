...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards reading how, tdd, and run until above the counter.](./images/recipes.jpg)
...
- **A vague finish condition.** "make it better" gives a recurring run nothing to check. Give a command or artifact that can pass or fail.
